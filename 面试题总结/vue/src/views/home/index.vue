 ...
 * @LastEditTime: 2020-08-03 16:10:10
          ...
          <li class="userLogin">
            <el-dropdown @command="operate">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item :divided="item.line" :command="item.id" v-for="(item, index) in userMenu" :key="index">
      ...
      <el-container class="innerContainer">
        ...
        <el-aside>
          <el-menu
            ...
            background-color="#fff"
            text-color="#000"
            active-text-color="#CA0C16"
            :unique-opened="true"
            router>
            <el-menu-item index="/page/home">
              <template slot="title">
            ...
            <el-submenu index="/page">
              <template slot="title">
                <i class="iconfont guanli"></i>
                <span class="tit">博客管理</span>
              </template>
              <el-menu-item index="/page/articleManage">文章管理</el-menu-item>
            </el-submenu>
            <el-submenu index="/downloadManage">
              <template slot="title">
                <i class="iconfont xiazai"></i>
                <span class="tit">下载管理</span>
              </template>
             <el-menu-item index="/page/downloadDetail">下载明细</el-menu-item>
            </el-submenu>
             <el-menu-item index="/incomeCenter">
              <template slot="title">
                <i class="iconfont shouyi"></i>
                <span class="tit">收益中心</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/ataDatail">
              <i class="iconfont shuju"></i>
              <span slot="title" class="tit">数据观星</span>
            </el-menu-item>
          </el-menu>
        </el-aside>
        <!-- 侧边导航栏 end -->
